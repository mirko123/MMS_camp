...
typedef void (*queue_critical)(struct queue_object *);
typedef void *(*queue_search)(struct queue_object *, int, datum *);
typedef void (*queue_del)(struct queue_object *, void *);
typedef void *(*queue_iterator)(struct queue_object *, void *, int *, datum *, int *);
...
struct queue_object {
	...
	queue_getter getB;
	queue_getter getE;
	queue_critical begin_crit;
	queue_critical end_crit;
	queue_search search;
	queue_del del;
